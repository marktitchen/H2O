...
<head>
<title>Grimsby Golf Club - Feedback System</title>
    ...
    <div class="container">
      <h1>Add New User </h1><br>
        ...
        <select name="accountCategory">
            ...
            <option value="Greenkeepers">Greenkeepers</option>
            <option value="Staff">Staff</option>
          </select><br><br>
        First Name: <input type="text" name="employeeFName" required/><br><br>
        Last Name: <input type="text" name="employeeLName" required/><br><br>
        Email: <input type="text" name="userEmail" required/><br><br>
        Password: <input type="password" name="userPassword" required/><br><br>
        <button type="submit" name="userchoice" value="registerstaff" class="registerbtn">ADD STAFF</button> 
    </div>
  </form>

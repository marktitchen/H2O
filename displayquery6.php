...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","getquery6.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<div class="topnav" id="myTopnav">
    ...
    <a href="displayquery6.php"class="active"> Query 6</a>
...
<h1> Query 6 - Customer Order Payment Method and Shop Method Query </h1>
<br>
